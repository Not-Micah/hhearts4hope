...
const BranchDisplay: React.FC<BranchDisplayProps> = ({ branch }) => {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-3 mb-9">
            <div className="w-full flex justify-start items-start gap-x-16">
                ...
                <div>
                    ...
                    <p className="text-content">{branch.description}</p>
                </div>
            </div>
            <div className={`w-full bg-black/10 drop-shadow rounded-lg p-6 my-6 overflow-y-auto no-scrollbar
            ${gallery?.length === 0 && 'hidden'}`}>
